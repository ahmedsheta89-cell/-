 ...
 * @description Deterministic SHA-256 cryptographic hashing utility for religious data integrity manifests.
 * Guaranteed to operate identically in browser and Node environments with full UTF-8 Arabic support.
 */
